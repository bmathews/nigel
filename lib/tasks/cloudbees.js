...
module.exports = function (nigel, config, register) {
    ...
    function doRequest (action, params, auth, formatter, method, payload) {
         ...
         */
        function getParams () {
            var opts = _.extend({}, config, params, auth);
    ...
    register("app list", [], "Gets a the list of apps.", function (message, outputStream, runConfig) {
        doRequest('application.list', {}, runConfig.auth, function (results) {
     ...
     *     app_id
     */
    register("app info", [], "Gets meta information of an app <app_id>", function (message, outputStream, runConfig) {
        doRequest('application.info', { app_id: message }, runConfig.auth, function (results) {
    ...
    register("database list", [], "Gets a the list of apps.", function (message, outputStream, runConfig) {
        doRequest('database.list', message, runConfig.auth, function (results) {
    ...
    /**
     * Gets info for a single database.
     * params:
     *     database_id
     */
    register("database info", [], "Gets meta information of a database <database_id>", function (message, outputStream, runConfig) {
        doRequest('database.info', {database_id: message}, runConfig.auth, function (results) {
