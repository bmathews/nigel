...
module.exports = function (nigel, config, register) {
    ...
    function doRequest (action, params, formatter, method, payload) {
        ...
        function getParams () {
            ...
            var paramNames = Object.keys(reqConfig).concat(Object.keys(params)).sort(),
                paramString = '',
                sig = '';

            paramNames.forEach(function (paramName) {
                var value = reqConfig[paramName] || params[paramName];
     ...
     * Get all apps
     */
    register("app list", [], "Gets a the list of apps.", function (message, outputStream) {
        doRequest('application.list', config, function (results) {
    ...
    register("database list", [], "Gets a the list of apps.", function (message, outputStream) {
        doRequest('database.list', config, function (results) {
